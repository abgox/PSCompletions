...
|[fnm](https://github.com/Schniz/fnm)|**en-US**<br>**zh-CN(8.33%)**|快速、简单的 Node.js 版本管理器，使用 Rust 构建。|
...
|[git](https://git-scm.com)|**en-US**<br>**zh-CN(98.8%)**|Git - 版本控制系统。|
...
|[pip](https://github.com/pypa/pip)|**en-US**<br>**zh-CN(99.42%)**|pip - Python 包管理器。|
...
|[psc](https://github.com/abgox/PSCompletions)|**en-US**<br>**zh-CN(97.55%)**|PSCompletions 模块的补全提示<br> 它只能更新，不能移除<br> 如果移除它，将会自动重新添加|
