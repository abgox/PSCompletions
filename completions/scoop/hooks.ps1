        ...
        'config' {
            $configList = [PSCustomObject]@{
                ...
                'app-uninstall-action-level'      = @{
                    'zh-CN' = @('默认值: 1', '应用卸载操作级别。', '它是 abyss bucket (https://gitee.com/abgox/abyss) 中的一个配置项', '详情参考: https://gitee.com/abgox/abyss#config')
                    'en-US' = @('Default Value: 1', 'The level of app uninstall action.', 'It is a config in abyss bucket (https://github.com/abgox/abyss).', 'See https://github.com/abgox/abyss#config for details.')
                }
