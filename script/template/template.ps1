...
Register-ArgumentCompleter -CommandName (_psc_get_cmd $PSScriptRoot $template_comp) -ScriptBlock {
    ...
    foreach ($_ in $_json) {
        ...
        $completions[(_psc_get_cmd $PSScriptRoot $template_comp) + ' ' + $_.Name] = [CompletionResult]::new($subcmd, $subcmd, 'ParameterValue', (_psc_replace $_.value))
    }
    #endregion
