...
|[oh-my-posh](https://ohmyposh.dev)|[**en-US**](/completions/oh-my-posh/language/en-US.json)<br>[**zh-CN(10.53%)**](/completions/oh-my-posh/language/zh-CN.json)|oh-my-posh is a cross platform tool to render your prompt.|
